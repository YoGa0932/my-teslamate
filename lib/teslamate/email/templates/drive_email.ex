defmodule TeslaMate.Email.Templates.DriveEmail do
          ...
          <div class="section">
            ...
            <div class="stats">
              <div class="stat-box">
                ...
                <div class="value">#{Float.round(drive.distance, 2)} km</div>
              </div>
              <div class="stat-box">
              ...
              <div class="stat-box">
                ...
                <div class="value">#{if drive.avg_speed, do: "#{Float.round(drive.avg_speed, 1)} km/h", else: "Not available"}</div>
              </div>
            </div>
          </div>
          ...
          <div class="section">
            ...
            <div class="info-grid">
              <div class="info-row">
                ...
                <div class="value">#{Float.round(drive.start_km, 1)} km</div>
              </div>
              <div class="info-row">
                <div class="label">🎯 End Odometer</div>
                <div class="value">#{Float.round(drive.end_km, 1)} km</div>
              </div>
            </div>
          </div>
  ...
  def generate_text(drive) do
    ...
    📊 Drive Statistics:
    - 📏 Distance: #{Float.round(drive.distance, 2)} km
    - ⏱️ Duration: #{drive.duration_min} minutes
    - 🏎️ Max Speed: #{drive.speed_max} km/h
    - 📊 Avg Speed: #{if drive.avg_speed, do: "#{Float.round(drive.avg_speed, 1)} km/h", else: "Not available"}
    ...
    - 🏁 Start Odometer: #{Float.round(drive.start_km, 1)} km
    - 🎯 End Odometer: #{Float.round(drive.end_km, 1)} km
