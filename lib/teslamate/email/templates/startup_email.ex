defmodule TeslaMate.Email.Templates.StartupEmail do
        ...
        #{if info.latest_drive do
          ...
          <div class="stats">
            <div class="stat-box">
              ...
              <div class="value">#{Float.round(info.latest_drive.distance, 2)} km</div>
            </div>
            <div class="stat-box">
          ...
          <div class="section">
            ...
            <div class="info-grid">
              <div class="info-row">
                ...
                <div class="value">#{Float.round(info.latest_drive.start_km, 1)} km</div>
              </div>
              <div class="info-row">
                <div class="label">🎯 End Odometer</div>
                <div class="value">#{Float.round(info.latest_drive.end_km, 1)} km</div>
              </div>
            </div>
          </div>
          ...
          <div class="section route-map-section">
            ...
            <div class="route-map-container">
              #{TeslaMate.Email.generate_route_map_html(info.latest_drive.id)}
            </div>
          </div>
          """
        else
  ...
  def generate_text(info) do
    ...
    #{if info.latest_drive do
      ...
      - 🏁 Start Odometer: #{Float.round(info.latest_drive.start_km, 1)} km
      - 🎯 End Odometer: #{Float.round(info.latest_drive.end_km, 1)} km
