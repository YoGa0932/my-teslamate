defmodule TeslaMate.Email.Templates.ChargingEmail do
          ...
          <div class="section">
            ...
            <div class="stats">
              ...
              <div class="stat-box">
                ...
                <div class="value">#{if charging_process.duration_min && charging_process.charge_energy_added, do: "#{Float.round(charging_process.charge_energy_added / (charging_process.duration_min / 60), 1)} kW", else: "Not available"}</div>
              </div>
            </div>
          </div>
  ...
  def generate_text(charging_process) do
    ...
    - ⚡ Avg Power: #{if charging_process.duration_min && charging_process.charge_energy_added, do: "#{Float.round(charging_process.charge_energy_added / (charging_process.duration_min / 60), 1)} kW", else: "Not available"}
